...
//        pose.add(new FollowPath(new Pose2d(24, 39 * Side.getNum(Side_), -90 * Side.getNum(Side_)), new Pose2d(2, 2, 3), 4, 1));
        pose.add(new FollowPath(new Pose2d(26, 70 * Side.getNum(Side_), -90 * Side.getNum(Side_)), new Pose2d(2, 2, 3), 2, 1));
        pose.add(new FollowPath(new Pose2d(26, 70 * Side.getNum(Side_), -180 * Side.getNum(Side_)), new Pose2d(2, 2, 5), 4, 1, 1000));
...
//                pose.add(new FollowPath(new Pose2d(30, 10 * Side.getNum(Side_), -45 * Side.getNum(Side_)), new Pose2d(2, 2, 3), 2, 1.2, 2000));
        ...
        ThreadAction(new Lift(-1, 400, 40, true));
        ThreadAction(new LiftLinearBar(false, 40, true));
        ThreadAction(new Grabber(true, 600, 40, true));

        pose.add(new FollowPath(new Pose2d(24, 0 * Side.getNum(Side_), -90 * Side.getNum(Side_)), new Pose2d(2, 2, 3), 2, 1, 2000));

        pose.add(new FollowPath(new Pose2d(24, 30 * Side.getNum(Side_), -90 * Side.getNum(Side_)), new Pose2d(2, 2, 3), 2, 1, 2000));
        ...
        switch (stonePosition){
            case RIGHT:
                pose.add(new FollowPath(new Pose2d(36, -20 * Side.getNum(Side_), -90 * Side.getNum(Side_)), new Pose2d(2, 2, 3), 4, 1, 3000));
...
//                pose.add(new FollowPath(new Pose2d(36, 55 * Side.getNum(Side_), -90 * Side.getNum(Side_)), new Pose2d(2, 2, 3), 2, 1));
        ...
        ThreadAction(new LiftLinearBar(false, 55, true));
        ThreadAction(new Lift(-1, 600, 45, true));
        ThreadAction(new Grabber(true, 1000, 55, true));
        ...
        ThreadAction(new Lift(1, 700, 60, false));
