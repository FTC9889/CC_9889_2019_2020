...
//@Deprecated
//@Disabled
public class TestTeleOpStonePipeline extends LinearOpMode {
    ...
    public void runOpMode()
    {
        ...
        phoneCam = OpenCvCameraFactory.getInstance().createWebcam(hardwareMap.get(WebcamName.class, Constants.kWebcam), cameraMonitorViewId);
